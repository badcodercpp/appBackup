...
var unlock = function unlock() {
    ...
    var promise = new _promise2.default(function (resolve, reject) {
        ...
        _connection2.default.query('SELECT BjsKey, Hash, iv FROM BJS_Lock WHERE BjsKey=\'' + phone + '\' OR Email=\'' + email + '\'', function (e, r, f) {
            if (!e) {
                var data = (0, _head3.default)(JSON.parse((0, _stringify2.default)(r)));
                console.log(r);
                var hash = (0, _get3.default)(data, 'Hash');
                var iv = (0, _get3.default)(data, 'iv');
                resolve({ hash: hash, iv: iv });
            } else {
