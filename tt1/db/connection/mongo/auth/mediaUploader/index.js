...
var doSignUp = exports.doSignUp = function doSignUp(payload) {
    var dbName = _config.MEEWEE.DB;
    console.log("payload", payload);
    var userSignupPromise = new _promise2.default(function (res, rej) {
        (0, _connection.connect)().then(function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(client) {
                var db, collection, payloadWithEmail, isExisting, userData, isExistingUsers, payloadWithMobile, isExistingMobile, data;
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                db = client.db(dbName);
                                collection = db.collection(MONGO.COLLECTION.badCollection);
