...
app.get('/sendOtp/:mobile', function (req, res) {
  ...
  (0, _otp2.default)(mobile, otp).then(function () {
...
app.get('/getAudio/:fileName', function (req, res) {
  var newClient = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });    
  var _ref9 = req.params || {},
      fileName = _ref9.fileName;

  newClient.connect(function () {
    var db = newClient.db('meewee');
    console.log(db);
    var bucket = new GridFSBucket(db, { bucketName: 'mwsounds' });
