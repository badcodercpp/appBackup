...
app.post('/saveFCMDeviceId', jsonParser, function (req, res) {
  ...
  c1.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _db, r;
...
app.post('/mwRegister', jsonParser, function (req, res) {
  ...
  var c1 = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });
  c1.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var r, otpInDb, c;
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if ((0, _isEqual3.default)(otp, otpInDb)) {
              ...
              c.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                var db, data, _r;
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        db = client.db('bad');
                        _context2.prev = 1;
                        data = _extends({}, _mockUser2.default, register);
                        _context2.next = 5;
...
app.post('/makeMWUser', jsonParser, function (req, res) {
  var body = req.body || {};
  var data = _extends({}, _mockUser2.default, body);
  client.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var db, r;
...
app.get('/sendOtp/:mobile', function (req, res) {
  ...
  (0, _otp2.default)(undefined, otp).then(function () {
    client.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
      var db, data, r;
...
app.post('/createMWMixin', jsonParser, function (req, res) {
  ...
  client.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    var db, r;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return db.collection('mwmixin').insertOne(_extends({}, data, { createdDate: Date.now() }));
...
app.post('/addMWUser', jsonParser, function (req, res) {
  var body = req.body || {};
  var data = _extends({}, _mockUser.user, body);
  client.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    var db, r;
...
app.post('/getUser', jsonParser, function (req, res) {
  ...
  client.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
    var db, r;
...
app.post('/getMWMixin', jsonParser, function (req, res) {
  ...
  var knownOnes = (0, _map3.default)([].concat(_toConsumableArray(followers), _toConsumableArray(followings)), function (user) {
    var phone = (0, _get3.default)(user, 'mobile');
    return phone;
  });
  var targetUsers = [mobile].concat(_toConsumableArray(knownOnes));
  client.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
    var db, cursor, users;
...
app.post('/searchUser', jsonParser, function (req, res) {
  ...
  client.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
...
app.post('/getUsersDetail', jsonParser, function (req, res) {
  ...
  client.connect(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
    var db, r;
        ...
        ffmpeg().input(v_n_1 + '__' + a_n_1 + '.mp4').input(v_n_2 + '__' + a_n_2 + '.mp4').input(v_n_2 + '__' + a_n_2 + '.mp4').setDuration(60).complexFilter(['[0]pad=2*iw:ih[l]', '[1]setpts=PTS-STARTPTS+30/TB[1v]', '[l][1v]overlay=x=W/2[a]', '[2]setpts=PTS-STARTPTS+250/TB[2v]', '[a][2v]overlay=x=W/2[v]', '[1]adelay=30000|30000[1a]', '[0][1a]amix=inputs=2[a]']).outputOptions('-map [v]').outputOptions('-map [a]').outputOptions('-ac 2').outputOptions('-preset veryfast').output(v_n_1 + '__' + a_n_1 + '__' + v_n_2 + '__' + a_n_2 + '__final_duke.mp4').on('end', function () {
          ...
          ffmpeg(v_n_1 + '__' + a_n_1 + '__' + v_n_2 + '__' + a_n_2 + '__final_duke.mp4').output(v_n_1 + '__' + a_n_1 + '__' + v_n_2 + '__' + a_n_2 + '__final_duke__reactions.mp4').on('end', function () {
            ...
            client.connect(function () {
              ...
              console.log(uploadStream.id, "id");
              uploadStream.once('finish', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12() {
                var data;
    ...
    ffmpeg().input(v_n_1_p_1).input(a_n_1_p_1).setStartTime('00:00:00').setDuration(30).outputOption('-map 0:0').outputOption('-map 1:0').audioCodec('aac').videoCodec('mpeg4').output(v_n_1_1 + '__' + a_n_1_1 + '__steady__.mp4').on('end', function () {
      ...
      ffmpeg(v_n_1_1 + '__' + a_n_1_1 + '__steady__.mp4').output(v_n_1_1 + '__' + a_n_1_1 + '__steady__final__.mp4').on('end', function () {
        ...
        client.connect(function () {
          ...
          console.log(uploadStream.id, "id");
          uploadStream.once('finish', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13() {
            var data;
