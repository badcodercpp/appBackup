...
exports.doGetUserDetails = undefined;
...
var doGetUserDetails = exports.doGetUserDetails = function doGetUserDetails(payload, req, res) {
    var dbName = _config.MONGO.DB;
    var userLoginPromise = new Promise(function (res, rej) {
