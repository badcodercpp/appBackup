...
var doGetMapData = function doGetMapData(req, res) {
    ...
    _connection2.default.query('SELECT * FROM BJS_MAPDATA', function (error, results, fields) {
        ...
        var sqlResults = ((0, _get3.default)((0, _head3.default)(JSON.parse(JSON.stringify(results))), [target]) || {}).slice(1, this.length) || '{}';
        console.log(sqlResults, (0, _get3.default)((0, _head3.default)(JSON.parse(JSON.stringify(results))), [target]));
        var schema = {
            lat: {},
            lng: {}
        };
